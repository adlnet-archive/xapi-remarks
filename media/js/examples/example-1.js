var remarks = [
  ...
  '<tyler@example.com> <answered> <question 1> ( r: "answer 2" ) { p: ["assessment 1"], g: ["page 5", "chapter 1", "cool book", "cool class"] }',
  '<tyler@example.com> <answered> <question 1> ( r: "answer 3" ) { p: ["assessment 1"], g: ["page 5", "chapter 1", "cool book", "cool class"] }',
  '<tyler@example.com> <answered> <question 1> ( r: "answer 2" ) { p: ["assessment 1"], g: ["page 5", "chapter 1", "cool book", "cool class"] }',
  '<tyler@example.com> <answered> <question 2> ( r: "answer 4" ) { p: ["assessment 1"], g: ["page 5", "chapter 1", "cool book", "cool class"] }',
  '<tyler@example.com> <answered> <question 3> ( r: "answer 1" ) { p: ["assessment 1"], g: ["page 5", "chapter 1", "cool book", "cool class"] }',
